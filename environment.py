...
class Environment():
    ...
    """
    def __init__(self, file_name="Tennis.app", train_mode=False, no_graphics=False):
        # Initialise random seed environment:
        self.env = UnityEnvironment(file_name=file_name, no_graphics=no_graphics, seed=random.seed(9999999))
